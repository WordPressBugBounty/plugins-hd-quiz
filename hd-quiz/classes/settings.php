				...
				"children": [
					{
						...
						"placeholder": "",
						"description": "You can use custom variables here to add dynamic content. <code>%quiz%</code> will display the quiz name, and <code>%score%</code> will display the user\'s score as a fraction.",
					...
					},
					{
						...
						"placeholder": "",
						"description": "You can use custom variables here to add dynamic content. <code>%quiz%</code> will display the quiz name, and <code>%score%</code> will display the outcome title.",
						"tooltip": "This is the text that will appear when a user share\'s their quiz",
						"prefix": "",
						"postfix": "",
						"type": "text"
			...
			{ "heading_type": "H3", "heading_content": "Other Options", "type": "heading" },
			{
				...
				"children": [
					...
					},
					{
						...
						"default": "yes",
						"tooltip": "",
						"description": "Disable if you want to hide the percentage score in the results, and only show the score as a fraction.",
						"placeholder": "",
						"options": [{ "label": "Yes", "value": "yes" }],
						"type": "radio"
					},
