            ...
            { "content": "If you are having trouble with either the Randomization options, or the Pool of Questions, make sure you do not have page caching enabled on the pages with quizzes. Your caching solution is creating a static version of the quiz once, and loading that same order each time.", "type": "content" },
			{
				...
				"children": [
					...
					},
					{
						...
						"default": "",
						"tooltip": "",
						"description": "This feature will randomize the order of all questions. <br/><a href = \"https://hdplugins.com/learn/documentation/hd-quiz-documentation/#randomisation-is-not-working\" target = \"_blank\">Need help?</a>",
						"placeholder": "",
						"options": [{ "label": "Yes", "value": "yes" }],
						"type": "radio"
					},
					{
						...
						"default": "",
						"tooltip": "",
						"description": "This feature will randomize the order that each answer is displayed. <br/><a href = \"https://hdplugins.com/learn/documentation/hd-quiz-documentation/#randomisation-is-not-working\" target = \"_blank\">Need help?</a>",
						"placeholder": "",
						"options": [{ "label": "Yes", "value": "yes" }],
						"type": "radio"
					},
					{
						...
						"description": "If you want each quiz to randomly grab a number of questions from the quiz, then enter that amount here. <small>Example: you might have 100 questions attached to this quiz, but entering 20 here will make the quiz randomly grab 20 of the questions on each load.</small> <a href = \"https://hdplugins.com/learn/documentation/hd-quiz-documentation/#randomisation-is-not-working\" target = \"_blank\">Need help?</a>",
						"placeholder": "",
						"prefix": "",
						"postfix": "questions",
						"options": "",
					...
					},
					{
						...
						"required": "",
						"default": "",
						"tooltip": "It is not recommended to use this unless you have a specific use case. It is recommended to use the \"paginate\" option on each question instead.",
						"description": "WP Paginate will force this number of questions per page, and force new page loads for each new question group. This feature is not compatible with several other features such as randomization and timers. <br/><br/><small><strong>WARNING:</strong> This feature will be discontinued sometime in the future. Although I will keep the feature included in its current form, you will need to add <code>HDQ_ENABLE_WP_PAGINATION</code> to your theme\'s <code>functions.php</code> file for continued use.</small>",
						"placeholder": "",
						"prefix": "",
						"postfix": "per page",
						"options": "",
